...
import { createPerformanceToolPlugin } from './performance/performancePlugin.js';
import { createCodeIntelligenceToolPlugin } from './codeIntelligence/codeIntelligencePlugin.js';
...
export function registerDefaultNodeToolPlugins(): void {
  ...
  registerToolPlugin(createCodeIntelligenceToolPlugin());
  ...
  registerToolPlugin(createPerformanceToolPlugin());
